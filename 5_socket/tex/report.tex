...
\begin{lstlisting}[caption=成績情報追加1,label=add_1]
  ...
  Thread-0:recv[list]
  Thread-0:send[  1   Michael  75  86  89  31 70.3]
  Thread-0:send[  2      Emma  74  63  70  48 63.8]
  Thread-0:send[  3    Hannah  73  45  82  31 57.8]
  Thread-0:send[  4     Emily  40  30  49  48 41.8]
  Thread-0:send[  5    Daniel  46  59  47  70 55.5]
  Thread-0:send[  6    Oliver  59  26  61  44 47.5]
  Thread-0:send[select search,add,list : ]
  Thread-0:recv[add]
